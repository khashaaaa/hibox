  	...
  	<div id="header">
    	...
    	<div id="viewList">
    			...
    			<label><?php echo LBL_BTN_VIEW_OPTIONS; ?></label>
					...
					?></div>
				<ul id="actionHeader">
					<li><a href="javascript:void(0)" id="actionRefresh" onclick="return windowRefresh();"><span><?php echo LBL_ACTION_REFRESH; ?></span></a></li>
					<li><a href="javascript:void(0)" id="actionSelectAll" class="check_all" onclick="return checkAll(this);"><span><?php echo LBL_ACTION_SELECT_ALL; ?></span></a></li>
					<?php 
						if(CONFIG_OPTIONS_DELETE)
						{
							?>
							<li><a href="javascript:void(0)" id="actionDelete" onclick="return deleteDocuments();"><span><?php echo LBL_ACTION_DELETE; ?></span></a></li>
							<?php
						}
					?>
					<?php 
						...
						{
							?>
							<li><a href="javascript:void(0)" id="actionCut" onclick="return cutDocuments('<?php echo ERR_NOT_DOC_SELECTED_FOR_CUT; ?>');"><span><?php echo LBL_ACTION_CUT; ?></span></a></li>			
							<?php
						}
					?>
					<?php 
						...
						{
							?>
							<li><a href="javascript:void(0)" id="actionCopy" onclick="return copyDocuments('<?php echo ERR_NOT_DOC_SELECTED_FOR_COPY; ?>');"><span><?php echo LBL_ACTION_COPY; ?></span></a></li>
							<?php
						}
					?>
					<?php 
						...
						{
							?>
							<li><a href="javascript:void(0)" id="actionPaste" onclick="return pasteDocuments('<?php echo ERR_NOT_DOC_SELECTED_FOR_PASTE; ?>');"><span><?php echo LBL_ACTION_PASTE; ?></span></a></li>
							<?php
						}
					?>															
					...
					<?php 
						...
						{
							?>
							<li><a  id="actionNewFolder" href="javascript:void(0)" onclick="return newFolderWin(this);"><span><?php echo LBL_BTN_NEW_FOLDER; ?></span></a></li>
							<?php
						}
					?>
					<?php 
						...
						{
							?>
							<li><a  id="actionUpload" href="javascript:void(0)" onclick="return uploadFileWin(this);"><span><?php echo LBL_BTN_UPLOAD; ?></span></a></li>
							<?php
						}
					?>
					...
					<li><a href="javascript:void(0)" id="actionClose" onclick="return cancelSelectFile();"><?php echo IMG_BTN_CLOSE; ?></a></li>
					<li><a href="javascript:void(0)" class="thickbox" id="actionInfo" onclick="return infoWin(this);"><span>Info</span></a></li>
					<!-- thest functions will be added in the near future
 					<li ><a href="javascript:void(0)" id="actionZip"><span>Zip</span></a><li>
					<li ><a href="javascript:void(0)" id="actionUnzip"><span>Unzip</span></a><li>-->
				</ul>    
<form action="" method="POST" name="formAction" id="formAction"><input type="hidden" name="currentFolderPath" id="currentFolderPathVal" value="" /><select name="selectedDoc[]" id="selectedDoc" style="display:none;" multiple="multiple"></select><input type="hidden" name="action_value" value="" id="action_value" /></form>				  
        		...
        		<table border="0" cellpadding="0" cellspacing="0" >
        			<tr>
        				...
        				<td width="1%" nowrap style="padding-right:16px;">
        					<a href="javascript:void(0)" onclick="return searchDocuments();" class="buttonLink"><span><?php echo BTN_SEARCH; ?></span></a>
        ...
        <p class="searchButtons" id="returnCurrentUrl">
         		<table border="0" cellpadding="0" cellspacing="0" >
        			<tr>
    					<td width="99%">&nbsp;</td>
        				<td width="1%" nowrap style="padding-right:16px;">
        					<a href="javascript:void(0)" id="selectCurrentUrl"  class="buttonLink"><span><?php echo MENU_SELECT; ?></span></a>
  ...
  <div id="winUpload" style="display:none">
  	<div class="jqmContainer">
  		<div class="jqmHeader">
  			<a href="javascript:void(0)" onclick="tb_remove();"><?php echo LBL_ACTION_CLOSE; ?></a>
  		</div>
  		<div class="jqmBody">
		  	...
		  	<table class="tableForm" cellpadding="0" cellspacing="0">
		  		<thead>
		  			<tr>
		  				<th colspan="4"><?php echo FILE_FORM_TITLE; ?><a class="action" href="javascript:void(0)" title="<?php echo FILE_LBL_MORE;  ?>" onclick="return addMoreFile();"><span class="addMore">&nbsp;</span></a></th>
		  			</tr>
		  		</thead>
		  		<tbody id="fileUploadBody">
		  			<tr style="display:none">
		  				...
		  				<td>
			        		<a href="javascript:void(0)" class="buttonLink"><span><?php echo FILE_LBL_UPLOAD; ?></span></a>		  				
		  				</td>
		  				<td> <a href="javascript:void(0)" class="action" title="Cancel" style="display:none" ><span class="cancel">&nbsp;</span></a>  <span class="uploadProcessing" style="display:none">&nbsp;<span></td>
		  			</tr>		
		  		</tbody>
		  		<tfoot>
		  			<tr>
  ...
  <div id="winNewFolder" style="display:none">
  	<div class="jqmContainer">
  		<div class="jqmHeader">
  			<a href="javascript:void(0)" onclick="return tb_remove();"><?php echo LBL_ACTION_CLOSE; ?></a>
  		</div>
  		<div class="jqmBody">
	  				...
	  				<th >&nbsp;</th>
		  				...
		  				<td nowrap>
		  					<table cellpadding="0" cellspacing="0" border="0">
		  						<tr>
		  							<td width="99%">&nbsp;</td>
		  							<td nowrap width="1%"><a href="javascript:void(0)" class="buttonLink" onclick="return doCreateFolder();" ><span><?php echo FOLDER_LBL_CREATE; ?></span></a>		</td>
		  						</tr>
		  					</table>
  ...
  <div id="winPlay" style="display:none">
  	<div class="jqmContainer">
  		<div class="jqmHeader">
  			<a href="javascript:void(0)" onclick="return closeWinPlay();"><?php echo LBL_ACTION_CLOSE; ?></a>
  		</div>
  		<div class="jqmBody">
		  			...
		  			<tr>
		  				...
		  				<td nowrap>
		  					<table cellpadding="0" cellspacing="0" border="0">
		  						<tr>
		  							<td width="99%">&nbsp;</td>
		  							<td nowrap width="1%"><a href="javascript:void(0)" class="buttonLink" onclick="return doRename();" ><span><?php echo RENAME_LBL_RENAME; ?></span></a>	</td>
		  						</tr>
		  					</table>
  ...
  <div id="contextMenu" style="display:none">
  	<ul>
  		<li><a href="javascript:void(0)" class="contentMenuItem" id="menuSelect"><?php echo MENU_SELECT; ?></a></li>
  		<li><a href="javascript:void(0)" class="contentMenuItem"  id="menuPreview"><?php echo MENU_PREVIEW; ?></a></li>
  		<li><a href="javascript:void(0)" class="contentMenuItem"  id="menuDownload"><?php echo MENU_DOWNLOAD; ?></a></li>
  		<li><a href="javascript:void(0)" class="contentMenuItem"  id="menuRename"><?php echo MENU_RENAME; ?></a></li>
  		<li><a href="javascript:void(0)" class="contentMenuItem"  id="menuEdit"><?php echo MENU_EDIT; ?></a></li>
  		<li><a href="javascript:void(0)" class="contentMenuItem"  id="menuCut"><?php echo MENU_CUT; ?></a></li>
  		<li><a href="javascript:void(0)" class="contentMenuItem" id="menuCopy"><?php echo MENU_COPY; ?></a></li>
  		<li><a href="javascript:void(0)" class="contentMenuItem"  id="menuPaste"><?php echo MENU_PASTE; ?></a></li>
  		<li><a href="javascript:void(0)" class="contentMenuItem"  id="menuDelete"><?php echo MENU_DELETE; ?></a></li>
  		<li><a href="javascript:void(0)" class="contentMenuItem"  id="menuPlay"><?php echo MENU_PLAY; ?></a></li>
  	</ul>
  </div>
</body>
</html>