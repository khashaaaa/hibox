...
$base_url = ($_GET['relative_urls'] == 'false' && $_GET['remove_script_host'] == 'false') ? getWebRoot() : ''; //url base of site if you want only relative url leave empty
$upload_dir = '/uploaded/'; // path from base_url to upload base dir
$current_path = '../../../../uploaded/'; // relative path from filemanager folder to upload files folder
