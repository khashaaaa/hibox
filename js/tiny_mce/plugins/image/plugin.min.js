tinymce.PluginManager.add("image", function(e) {
    function openmanager() {
        ...
        win = e.windowManager.open({
            ...
            data: data,
            classes: 'filemanager',
            file: tinyMCE.baseURL + '/plugins/filemanager/dialog.php?type=1&editor=' + e.id + '&lang=' + tinymce.settings.language + '&subfolder=' + tinymce.settings.subfolder + '&relative_urls=' + tinymce.settings.relative_urls + '&remove_script_host=' + tinymce.settings.remove_script_host,
            filetype: 'image',
            width: 900,
            height: 600,
            inline: 1
