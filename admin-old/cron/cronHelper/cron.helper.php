<?php  
	...
	// Данный класс позволяет избежать двойного выполнения скрипта со стороны CRON-а 
	// одновременно. 
	// Источник http://abhinavsingh.com/blog/2009/12/how-to-use-locks-in-php-cron-jobs-to-avoid-cron-overlaps/
  
    define('LOCK_DIR', BASE_ADMIN_PATH.'cron/cronHelper/');  
