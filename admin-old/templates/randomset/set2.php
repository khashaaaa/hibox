...
<div id="popular" class="block-container" >
    ...
    <ul id="sortable2" class="sortable">
        <? foreach ($set2 as $item): ?>
            <li class="sortlist" id="pop<?=$item['id']?>">
    ...
    <? } ?>
    <br/>
    <div id="save2" style="display:none;float:right;">
    ...
    <form id="form2" action="<?=BASE_DIR;?>index.php?sid=<?=$GLOBALS['ssid'];?>&amp;do=add&amp;cmd=randomset" method="post">
    ...
    <br/><br/>
    <form id="form2del" action="<?=BASE_DIR;?>index.php?sid=<?=$GLOBALS['ssid'];?>&amp;do=delall&amp;cmd=randomset" method="post">
        <input type="hidden" name="catid" value="<?=$catid?>"/>
