...
<div class="main"><div class="canvas clrfix">
        <div class="col700">
            <div class="tuning">
                ...
                <strong><?=LangAdmin::get('import_file_requirement_txt')?></strong><br/><br/>
                <form id="form1" action="<?=BASE_DIR;?>index.php?sid=<?=$GLOBALS['ssid'];?>&amp;do=import&amp;cmd=category" method="post" enctype="multipart/form-data">
...
function check_file() {
    ...
    if (fileName == "") {
        ...
        alert("Не верное расширение файла " + fileName.split(".")[1] + ". Требуемое расширение: .txt!");
