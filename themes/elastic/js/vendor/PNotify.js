  ...
  function create_if_block_2(component, ctx) {
    ...
    return {
      c: function c() {
          h6 = createElement("h6");
        if_block.c();
          h6.className = h6_class_value = "ui-pnotify-title " + (ctx._styles.title ? ctx._styles.title : '');
      },
      m: function m(target, anchor) {
        insert(target, h6, anchor);
        if_block.m(h6, null);
        component.refs.titleContainer = h6;
      },
      p: function p(changed, ctx) {
        ...
        if (changed._styles && h6_class_value !== (h6_class_value = "ui-pnotify-title " + (ctx._styles.title ? ctx._styles.title : ''))) {
      ...
      d: function d(detach) {
        ...
        if_block.d();
        if (component.refs.titleContainer === h6) component.refs.titleContainer = null;
      }
    };
  }
