...
(function ($) {
    ...
    EditableForm.prototype = {
        ...
        initButtons: function() {
            this.$form.find('.editable-buttons').append($.fn.editableform.buttons + this.options.extraButtons);
        },
        /**
    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/
        savenochange: false,
        /**
         Позволяет задать дополнительные кнопки управления
...
(function ($) {
    ...
    $.extend(Password.prototype, {
       //do not display password, show '******' instead
       value2html: function(value, element) {
           if(value) {
               $(element).text('******');
           } else {
