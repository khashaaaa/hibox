...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname(dirname(dirname(__DIR__))).'/files/',
    ...
    protected function get_upload_path($file_name = null, $version = null, $includeFileNameInPath = true) {
        ...
        $fileHash = md5($file_name);
        if(!$includeFileNameInPath) $file_name = '';
        return $this->options['upload_dir'].$this->get_user_path()
            .$version_path.substr($fileHash,0,2).'/'.substr($fileHash,2,2).'/'.$file_name;
    }
    ...
    protected function get_download_url($file_name, $version = null) {
        ...
        return $this->options['upload_url'].$this->get_user_path()
            .$version_path.substr($fileHash,0,2).'/'.substr($fileHash,2,2).'/'.rawurlencode($file_name);
    }
