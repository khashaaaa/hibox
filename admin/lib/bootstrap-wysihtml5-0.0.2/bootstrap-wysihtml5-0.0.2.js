        ...
        "link":     "<li>"
                        ...
                        + "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade'>"
                            ...
                            + "<a class='close' data-dismiss='modal'>×</a>"
                              + "<h3>" + trans.get('Insert_link') + "</h3>"
                            + "</div>"
                            + "<div class='modal-body'>"
                              + "<input value='http://' class='bootstrap-wysihtml5-insert-link-url input-xlarge'>"
                            + "</div>"
                            + "<div class='modal-footer'>"
                              + "<a href='#' class='btn' data-dismiss='modal'>" + trans.get('Cancel') + "</a>"
                              + "<a href='#' class='btn btn-primary' data-dismiss='modal'>" + trans.get('Insert_link') + "</a>"
                            + "</div>"
                        + "</div>"
            ...
            "image": "<li>"
                        ...
                        + "<div class='bootstrap-wysihtml5-insert-image-modal modal hide fade'>"
                            ...
                            + "<div class='modal-footer'>"
                              + "<a href='#' class='btn' data-dismiss='modal'>" + trans.get('Cancel') + "</a>"
                              + "<a href='#' class='btn btn-primary' data-dismiss='modal'>" + trans.get('Insert_image') + "</a>"
                            + "</div>"
                        + "</div>"
