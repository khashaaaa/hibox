...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null, $uploadFolder = false) {
        $this->options = array(
            ...
            'upload_dir' => dirname(dirname(dirname(dirname(__FILE__)))). ($uploadFolder ? $uploadFolder : '/brands_uploads/'),
            'upload_url' => $this->get_full_url().($uploadFolder ? $uploadFolder : '/brands_uploads/'),
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function get_upload_path($file_name = null, $version = null, $includeFileNameInPath = true) {
    ...
    protected function create_scaled_image($file_name, $version, $options) {
        $file_path = $this->get_upload_path($file_name);
        if (!empty($version)) {
            $version_dir = $this->get_upload_path($file_name, $version, false);
