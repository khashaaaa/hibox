...
class OtapiAddBrandInfo extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetXmlBrandInfo(){
        $value = isset($this->xmlData->xmlBrandInfo) ? (string)$this->xmlData->xmlBrandInfo : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}