...
class OtapiAddDiscountGroupToInstance extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetXmlAddData(){
        $value = isset($this->xmlData->xmlAddData) ? (string)$this->xmlData->xmlAddData : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}