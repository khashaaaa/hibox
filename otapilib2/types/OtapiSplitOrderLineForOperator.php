...
class OtapiSplitOrderLineForOperator extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetXmlSplitData(){
        $value = isset($this->xmlData->xmlSplitData) ? (string)$this->xmlData->xmlSplitData : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}