...
class OtapiFindCategoryItemSimpleInfoListFrame extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetCategoryItemFilter(){
        $value = isset($this->xmlData->categoryItemFilter) ? (string)$this->xmlData->categoryItemFilter : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**
