...
class OtapiRecreateOrder extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetXmlRecreateData(){
        $value = isset($this->xmlData->xmlRecreateData) ? (string)$this->xmlData->xmlRecreateData : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}