...
class OtapiPurchaseItems extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetSaleLineList(){
        $value = isset($this->xmlData->saleLineList) ? (string)$this->xmlData->saleLineList : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}