...
class OtapiCreateExternalDeliveryType extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetXmlExternalDeliveryType(){
        $value = isset($this->xmlData->xmlExternalDeliveryType) ? (string)$this->xmlData->xmlExternalDeliveryType : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}