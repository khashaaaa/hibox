...
class OtapiRemoveExternalDeliveryRate extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return int
     */
    public function GetExternalDeliveryRateId(){
        $value = isset($this->xmlData->externalDeliveryRateId) ? (string)$this->xmlData->externalDeliveryRateId : false;
        $propertyType = 'int';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}