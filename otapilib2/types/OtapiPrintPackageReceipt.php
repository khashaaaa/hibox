...
class OtapiPrintPackageReceipt extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetXmlPrintReceiptParameters(){
        $value = isset($this->xmlData->xmlPrintReceiptParameters) ? (string)$this->xmlData->xmlPrintReceiptParameters : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}