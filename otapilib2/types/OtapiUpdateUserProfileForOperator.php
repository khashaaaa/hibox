...
class OtapiUpdateUserProfileForOperator extends BaseOtapiType{
    /**
     * @return string
     */
    ...
    public function GetProfileId(){
        $value = isset($this->xmlData->profileId) ? (string)$this->xmlData->profileId : false;
        $propertyType = 'int';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**
    ...
    public function GetUpdateData(){
        $value = isset($this->xmlData->updateData) ? (string)$this->xmlData->updateData : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}