...
class OtapiUpdateMultipleOrderLineStatuses extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetOrderLineIdentificators(){
        $value = isset($this->xmlData->orderLineIdentificators) ? (string)$this->xmlData->orderLineIdentificators : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**
