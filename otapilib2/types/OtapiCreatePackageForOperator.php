...
class OtapiCreatePackageForOperator extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetXmlCreateData(){
        $value = isset($this->xmlData->xmlCreateData) ? (string)$this->xmlData->xmlCreateData : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}