...
class OtapiEditCategoriesVisible extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetCategoriesVisibleSettings(){
        $value = isset($this->xmlData->categoriesVisibleSettings) ? (string)$this->xmlData->categoriesVisibleSettings : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}