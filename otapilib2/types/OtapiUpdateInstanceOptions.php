...
class OtapiUpdateInstanceOptions extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetXmlInstanceOptionsData(){
        $value = isset($this->xmlData->xmlInstanceOptionsData) ? (string)$this->xmlData->xmlInstanceOptionsData : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}