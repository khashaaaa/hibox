...
class OtapiChangeOperatorPassword extends BaseOtapiType{
    /**
     * @return string
     */
    ...
    public function GetCurrentPassword(){
        $value = isset($this->xmlData->currentPassword) ? (string)$this->xmlData->currentPassword : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**
    ...
    public function GetNewPassword(){
        $value = isset($this->xmlData->newPassword) ? (string)$this->xmlData->newPassword : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}