...
class OtapiEditExternalDeliveryRate extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetXmlExternalDeliveryRate(){
        $value = isset($this->xmlData->xmlExternalDeliveryRate) ? (string)$this->xmlData->xmlExternalDeliveryRate : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}