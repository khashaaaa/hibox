...
class OtapiGetSalesOrdersListForOperator extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetXmlOrderFilter(){
        $value = isset($this->xmlData->xmlOrderFilter) ? (string)$this->xmlData->xmlOrderFilter : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}