...
class OtapiExportPackageToDeliveryServiceSystem extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetXmlExportParameters(){
        $value = isset($this->xmlData->xmlExportParameters) ? (string)$this->xmlData->xmlExportParameters : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}