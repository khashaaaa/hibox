...
class OtapiGetPaymentParameters extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetPaymentRequestXml(){
        $value = isset($this->xmlData->paymentRequestXml) ? (string)$this->xmlData->paymentRequestXml : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}