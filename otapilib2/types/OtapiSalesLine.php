...
class OtapiSalesLine extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetVendPurchAccountId(){
        $value = isset($this->xmlData->VendPurchAccountId) ? (string)$this->xmlData->VendPurchAccountId : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**
     * @return string
     */
    public function GetVendPurchStatus(){
        $value = isset($this->xmlData->VendPurchStatus) ? (string)$this->xmlData->VendPurchStatus : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**
     * @return string
     */
    public function GetVendPurchItemId(){
        $value = isset($this->xmlData->VendPurchItemId) ? (string)$this->xmlData->VendPurchItemId : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**
     * @return string
     */
    public function GetVendPurchConfigurationId(){
        $value = isset($this->xmlData->VendPurchConfigurationId) ? (string)$this->xmlData->VendPurchConfigurationId : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**
     * @return string
     */
    public function GetVendPurchPromotionId(){
        $value = isset($this->xmlData->VendPurchPromotionId) ? (string)$this->xmlData->VendPurchPromotionId : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**
     ...
     * @return string
     */
    public function GetConfigExternalCode(){
        $value = isset($this->xmlData->ConfigExternalCode) ? (string)$this->xmlData->ConfigExternalCode : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**
    ...
    public function CanBeReviewed(){
        $value = isset($this->xmlData->CanBeReviewed) ? (string)$this->xmlData->CanBeReviewed : false;
        $propertyType = 'boolean';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**
    ...
    public function GetReviewId(){
        $value = isset($this->xmlData->ReviewId) ? (string)$this->xmlData->ReviewId : false;
        $propertyType = 'int';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**
    ...
    public function CanBeClosed(){
        $value = isset($this->xmlData->CanBeClosed) ? (string)$this->xmlData->CanBeClosed : false;
        $propertyType = 'boolean';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**
