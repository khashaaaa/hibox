...
class OtapiEditPriceFormationGroup extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetXmlPriceFormationGroupInfo(){
        $value = isset($this->xmlData->xmlPriceFormationGroupInfo) ? (string)$this->xmlData->xmlPriceFormationGroupInfo : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}