...
class OtapiGetProviderOrdersIntegrationSessionAuthenticationInfo extends BaseOtapiType{
    /**
     * @return string
     */
    ...
    public function GetReturnUrl(){
        $value = isset($this->xmlData->returnUrl) ? (string)$this->xmlData->returnUrl : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}