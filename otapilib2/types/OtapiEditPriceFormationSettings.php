...
class OtapiEditPriceFormationSettings extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetXmlPriceFormationSettings(){
        $value = isset($this->xmlData->xmlPriceFormationSettings) ? (string)$this->xmlData->xmlPriceFormationSettings : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}