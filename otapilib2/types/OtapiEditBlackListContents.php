...
class OtapiEditBlackListContents extends BaseOtapiType{
    /**
     * @return string
     */
     ...
     * @return string
     */
    public function GetXmlContentsList(){
        $value = isset($this->xmlData->xmlContentsList) ? (string)$this->xmlData->xmlContentsList : false;
        $propertyType = 'string';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
}