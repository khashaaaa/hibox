...
class PHPExcel_Writer_Excel5 implements PHPExcel_Writer_IWriter
{
	...
	public function __construct(PHPExcel $phpExcel) {
		...
		$this->_tempDir			= dirname(dirname(dirname(dirname(dirname(__FILE__))))).'/cache/';
	...
	public function save($pFilename = null) {
		...
		//http://stackoverflow.com/questions/20650886/fatal-error-in-autoloader-php-on-line-34-phpexcel
