...
class Pagination
{
    public static function getPages($total_rows, $rows_per_page, $page_num)
    {
        $arr = array();
        // calculate last page
        ...
        $arr['pages'] = self::get_surrounding_pages($page_num, $last_page, $arr['next']);
        return $arr;
    }
    private static function get_surrounding_pages($page_num, $last_page, $next)
    {
        $arr = array();
